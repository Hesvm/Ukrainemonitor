          ...
          >
            ...
            >
              ...
              <button
                ...
                className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity font-mono text-[9px] uppercase tracking-wide px-2 py-1"
                style={{
              ...
              >
                {copiedId === variant.id ? 'Copied!' : 'Copy SVG'}
              </button>
            </div>
            <p
